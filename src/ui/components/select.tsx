									...
									{options.map((opt) => {
										...
										return (
											<li
												...
												tabIndex={opt.disabled ? -1 : 0}
												className={cn(
													"relative flex w-full cursor-pointer select-none items-center rounded-lg py-1.5 pl-8 pr-2 text-sm outline-none transition-colors hover:bg-mac-blue hover:text-white",
													opt.disabled &&
														"pointer-events-none opacity-50 cursor-not-allowed",
													isSelected
														? "text-foreground"
